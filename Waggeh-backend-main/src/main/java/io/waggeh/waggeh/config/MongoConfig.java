...
import io.waggeh.waggeh.util.MongoOffsetDateTimeReader;
import io.waggeh.waggeh.util.MongoOffsetDateTimeWriter;
...
@Configuration
@EnableMongoRepositories("io.waggeh.waggeh.repos")
